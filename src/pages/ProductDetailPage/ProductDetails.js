...
function ProductDetails() {
  ...
  useEffect(() => {
    setImage( product?.images[0]?.startsWith("http")
    ? product?.images[0]
    : product?.thumbnail);
    setBreadCrumbLinks([]);
    const arrayLinks = [
    ...
    <>
      <div className="flex flex-col md:flex-row px-10">
                ...
                {product?.images[0]?.startsWith("http") &&
                  product?.images?.map((item, index) => (
                    <button
                      ...
                      className="border rounded-lg w-fit p-2 mb-2"
                    >
                      <img
                        src={item}
                        className="h-[60px] w-[60px] bg-cover bg-center  rounded hover:scale-105"
                        alt={" sample -" + index}
                      />
                    </button>
                  ))}
        ...
        <div className="w-[60%] px-10">
          ...
          <div>
            <p className="text-lg bold">Colors Availaible</p>
